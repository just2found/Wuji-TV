                ...
                runOnUI {
                    ...
                    when(type){
                        ...
                        com.wuji.tv.Constants.ACCESS -> {
                            "getSession Exception msg:${msg}".log("DeviceFragment")
...
//        postMsg(CHANGE_LOADING_STATUS, SHOW_LOADING)
    ...
    /*fun download(token: String,session: String, paths: Array<String>, toUserPath: String,bt_ticket: String) {
//        postMsg(CHANGE_LOADING_STATUS, SHOW_LOADING)
        handleApiRequest {
